...
+ 1/2 LH conj[H].H.conj[H].H - 1/2 LHT conj[H].H.conj[trip].trip + 1/2 LHT2 conj[H].trip.conj[trip].H);


LagHC = - (Yd conj[H].d.q + Ye conj[H].e.l - Yu H.u.q + KHT H.conj[trip].H + Ynu l.trip.l);
